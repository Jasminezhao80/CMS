<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseDetailListForJqGrid - Copy (2).aspx.cs" Inherits="purchase_PurchaseDetailListForJqGrid" %>
            ...
            $("#tableList").jqGrid(
                {
                    ...
                    ondblClickRow: function (rowid, iRow, iCol, e) {
                        alert("ondblClickRow");
                         if (lastEditRow != rowid) {
                             $("#tableList").editRow(lastEditRow, false);
                             $("#tableList").editRow(rowid, true);
                        }
                        ...
                        alert("lastEditRow:" + lastEditRow + "rowId：" +rowid);
                       
                    },
                    afterSaveCell: function (rowid, name, val, iRow, iCol) {
                        var flag = "<%=editFlag%>";
                        alert("afterSaveCell:" + flag);
                        if (flag == "False") {
                            alert("此账号没有修改权限！");
                            return;
                        }
